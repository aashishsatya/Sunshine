...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        String locationSelection = WeatherContract.LocationEntry.COLUMN_LOCATION_SETTING + " = ?";
        ...
        if (mCursor.moveToFirst()) {
            ...
            // row already exists
            // just return the location ID

            int idColumnIndex = mCursor.getColumnIndex(WeatherContract.LocationEntry._ID);
        ...
        return ContentUris.parseId(weatherInsertUri);
    }
